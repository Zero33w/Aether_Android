...
import com.example.aether_app.UsuarioActivity;
...
public class ServicioEscucharBeacons  extends IntentService {
    ...
    public int onStartCommand( Intent elIntent, int losFlags, int startId) {
        ...
        // creo que este m̩todo no es necesario usarlo. Lo ejecuta el thread principal !!!
    ...
    public void parar () {
        ...
        UsuarioActivity.getInstancia().detenerBusquedaDispositivosBTLE();
        this.seguir = false;
        this.stopSelf();
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            UsuarioActivity.getInstancia().buscarEsteDispositivoBTLE(UUID);
            while ( this.seguir ) {
